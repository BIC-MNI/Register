START_GLOBALS
    ...
    DEF_GLOBAL( Default_button_pushed_colour, Colour, DIM_GRAY )
    ...
    DEF_GLOBAL_STRING( Position_values_format, "%.2lf" )
    ...
    DEF_GLOBAL_STRING( Slider_text_format, "%5.1f" )
